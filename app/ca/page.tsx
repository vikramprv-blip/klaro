...
const MODULE_CARDS = [
  { label: "GST filings",    href: "/ca/gst",         desc: "GSTR-1, 3B, 9 tracking",       color: "bg-blue-50   text-blue-800"   },
  { label: "TDS compliance", href: "/ca/tds",         desc: "24Q, 26Q, Form 16/16A",         color: "bg-purple-50 text-purple-800" },
  { label: "ITR tracker",    href: "/ca/itr",         desc: "ITR-1 to ITR-7, AY 2026-27",   color: "bg-teal-50   text-teal-800"   },
  { label: "Advance tax",    href: "/ca/advance-tax", desc: "4 instalment tracking",          color: "bg-amber-50  text-amber-800"  },
  { label: "Clients",        href: "/ca/clients",     desc: "Client master, PAN, GSTIN",     color: "bg-gray-50   text-gray-800"   },
  { label: "Deadlines",      href: "/ca/deadlines",   desc: "Full compliance calendar",       color: "bg-rose-50   text-rose-800"   },
]
        ...
        <div>
          ...
          {deadlines.length === 0 ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              {deadlines.length > 8 && (
                <Link href="/ca/deadlines" className="text-xs text-blue-500 hover:underline text-center py-1">
