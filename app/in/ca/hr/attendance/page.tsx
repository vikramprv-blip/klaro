...
<div className="mt-2"><a href="/in/ca/hr/attendance/leave" className="text-blue-600 text-sm">Apply Leave</a> <a href="/in/ca/hr/attendance/month" className="text-blue-600 text-sm ml-4">Monthly View</a></div>
