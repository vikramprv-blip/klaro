...
export default function LawyerOverviewPage() {
  ...
  const MODULES = [
    { label: "Matters",   href: "/in/lawyer/matters",   color: "bg-gray-50 text-gray-800",    stat: `${stats?.activeMatters ?? 0} active` },
    { label: "Hearings",  href: "/in/lawyer/hearings",  color: "bg-blue-50 text-blue-800",    stat: `${stats?.hearingsThisWeek ?? 0} this week` },
    { label: "Tasks",     href: "/in/lawyer/tasks",     color: "bg-amber-50 text-amber-800",  stat: `${stats?.pendingTasks ?? 0} pending` },
    { label: "Drafts",    href: "/in/lawyer/drafts",    color: "bg-purple-50 text-purple-800",stat: "AI drafting" },
    { label: "Documents", href: "/in/lawyer/documents", color: "bg-teal-50 text-teal-800",    stat: "Document vault" },
    { label: "Billing",   href: "/in/lawyer/billing",   color: "bg-green-50 text-green-800",  stat: "Time & fees" },
  ]
